...
import { S as Calendar, T as ArrowLeft, p as Menu, t as X, w as ArrowRight, y as ChevronRight } from "../_libs/lucide-react.mjs";
...
function BlogPage() {
	...
	const [selectedPostIndex, setSelectedPostIndex] = (0, import_react.useState)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/blog",
									className: "text-sm font-bold text-gradient hover:opacity-80 transition-opacity",
									children: "Wawasan"
								})
							]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									...
									className: "font-bold text-lg text-gradient hover:opacity-80 transition-all duration-300 hover:scale-105",
									children: "Wawasan"
								}),
			...
			activePost ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "pt-32 pb-24 px-6 relative max-w-[96vw] 2xl:max-w-[800px] mx-auto z-10",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-primary/15 rounded-full blur-[100px] -z-10 pointer-events-none opacity-45" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "w-4 h-4" }), " Kembali ke Artikel"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "h-64 md:h-96 w-full overflow-hidden rounded-2xl relative border border-border/40 mb-8",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-[10px] font-semibold px-3 py-1 rounded-full bg-white/10 backdrop-blur-md text-white border border-white/20 uppercase tracking-wider shadow-sm",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: activePost.author
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "text-2xl md:text-4xl font-extrabold mb-6 tracking-tight leading-tight",
						children: activePost.title
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-full h-px bg-border/40 my-6" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-base md:text-lg leading-relaxed text-muted-foreground whitespace-pre-line mb-10",
						children: activePost.content
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "glass-card p-6 md:p-8 rounded-2xl border-primary/20 text-center relative overflow-hidden",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent -z-10" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
								className: "text-lg md:text-xl font-bold mb-3",
								children: "Tertarik Belajar Pemrograman Bersama Kami?"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
								...
								children: ["Hubungi Mentor via WhatsApp ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "w-4 h-4" })]
							})
						]
					})
				]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-primary/20 rounded-full blur-[120px] -z-10 pointer-events-none opacity-50" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "w-full max-w-[96vw] 2xl:max-w-[1600px] mx-auto text-center reveal-up reveal in-view",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
							...
							children: ["Wawasan ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Temukan artikel terbaru seputar teknologi, panduan bisnis, dan strategi digital marketing untuk mengembangkan usaha Anda."
						})
					]
				})]
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "w-full max-w-[96vw] 2xl:max-w-[1200px] mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8",
					children: blogPosts.map((post, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "glass-card rounded-2xl overflow-hidden group flex flex-col h-full hover:border-primary/50 transition-all duration-500",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: post.author })]
								}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										children: ["Baca Selengkapnya ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-4 h-4 group-hover:translate-x-1 transition-transform" })]
									})
								})
							]
						})]
