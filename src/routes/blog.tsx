...
export const Route = createFileRoute("/blog")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.tembusdigital.studio/blog" },
      { property: "og:title", content: "Blog & Artikel — Tembus Digital" },
      { property: "og:description", content: "Kumpulan artikel, tips digital marketing, dan wawasan teknologi terbaru dari Tembus Digital." },
      ...
      { property: "og:image:alt", content: "Blog & Artikel Tembus Digital" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Blog & Artikel — Tembus Digital" },
      { name: "twitter:description", content: "Kumpulan artikel, tips digital marketing, dan wawasan teknologi terbaru dari Tembus Digital." },
