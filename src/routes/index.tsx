...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Layanan Jasa Pembuatan Aplikasi Mobile, Desktop & Website Modern" },
      { property: "og:description", content: "Pembuatan Aplikasi Android, iOS, Desktop, WebApps, Aplikasi Costum, Website dan Server untuk kebutuhan Bisnis Anda." },
      ...
      { property: "og:image:alt", content: "Tembus Digital" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Layanan Jasa Pembuatan Aplikasi Mobile, Desktop & Website Modern" },
      { name: "twitter:description", content: "Pembuatan Aplikasi Android, iOS, Desktop, WebApps, Aplikasi Costum, Website dan Server untuk kebutuhan Bisnis Anda." },
